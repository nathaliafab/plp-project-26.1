...
public class ContextoExecucaoFuncional implements AmbienteExecucaoFuncional {
	 ...
	 */
        ...
        public boolean isAlreadyOptional(Id idArg) { 
                return contextoExecucao.isAlreadyOptional(idArg); 
        }
	 ...
	 */
        ...
        public void map(Id idArg, Valor tipoId, boolean isOptional) throws VariavelJaDeclaradaException {
                contextoExecucao.map(idArg, tipoId, isOptional);
        }
